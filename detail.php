<?php session_start();
	...
	$q="select * from bkdetails where bk_id=$id";
			...
			<!-- start page -->
				...
				<div id="page">
						<!-- start content -->
							<div id="content">
								<div class="post">
									<h1 class="title"><?php echo $row['bk_name'];?></h1>
									<div class="entry">
										<?php
													...
													<td width="50%" height="100%">
														<table border="0"  width="100%" height="100%">
															...
															<tr>
																...
																<td>: </td>
																<td align="left">'.$row['bk_author'].'</td>
											...
											<table border="0" width="100%">
												 ...
												 {
													echo ' <td><a href="process_cart.php?nm='.$row['bk_name'].'&cat='.$_GET['cat'].'&rate='.$row['bk_price'].'">
