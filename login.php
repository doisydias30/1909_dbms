...
<div class="w-50 m-r">
		<form action="userinfo.php" method="post" class="needs-validation" novalidate>
			...
			<a href="home.php" button type="submit" class="btn btn-primary">Submit</a>
		  </form>
...
<footer class="signup-link"><span>Don&#x27;t have an account? <button><a href="register.php">Sign up</a></button></span></footer></div></div></div>
</div>
</main>
</div>
</div>
