...
require('includes/config.php');
 session_start();
	...
	$totalq="select count(*) \"total\" from bkdetails where b_subcat='$cat'";
									...
									<div class="entry">
										...
										<table border="4" width="100%" >
											...
											<?php
												...
												$query="select * from bkdetails where b_subcat='$cat' LIMIT ".$k .",".$page_per_page;
												...
												while($row=mysqli_fetch_assoc($res))
												{
													...
													echo '<td valign="top" width="20%" align="center">
														<a href="detail.php?id='.$row['bk_id'].'&cat='.$_GET['subcatnm'].'">
